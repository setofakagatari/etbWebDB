...
<div class="menu" id="menu">
    <a class="Amenu"href="../CreadorDeTickets/dashboard.php"><p>Inicio</p></a><pre>     </pre>	
	<a class="Amenu" href="../CreadorDeTickets/viewMyUser.php"><p>Mi perfil</p></a><pre>     </pre>	
	<a class="Amenu" href="../CreadorDeTickets/createTicket.php"><p>crear ticket</p></a><pre>     </pre>	
	<a class="Amenu" href="../CreadorDeTickets/myTickets.php"><p>mis tickets</p></a><pre>     </pre>
</div>
    </body>
</html>